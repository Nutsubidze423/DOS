...
const AppComponents: Record<AppId, React.LazyExoticComponent<AppComponent>> = {
  ...
  'solitaire': lazy(() => import('@/components/apps/Solitaire/Solitaire').then(m => ({ default: m.Solitaire }))),
    ...
    <AnimatePresence onExitComplete={() => play('window-close')}>
      {!win.isMinimized && (
        ...
        >
          ...
          <div className="flex-1 overflow-hidden bg-os-chrome relative" onContextMenu={e => e.preventDefault()}>
            <Suspense
              fallback={
